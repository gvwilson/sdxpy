...
and the [*Browser Engineering*][browser_engineering] book
...
instead of using those provided by various libraries;
...
([% fixme layout-coordinate-system %]).
...
## How can we size rows and columns? {: #layout-size}
...
[% fixme file="easy-mode.js" keep="block" %]
...
[% fixme file="easy-mode.js" keep="row" %]
...
[% fixme file="easy-mode.js" keep="col" %]
...
[% fixme file="test/test-easy-mode.js" %]
[% fixme file="test-easy-mode.out" %]

## How can we position rows and columns? {: #layout-position}
...
[% fixme file="placed.js" keep="block" %]

while our columns are:
{: .continue}

[% fixme file="placed.js" keep="col" %]

and our rows are:
{: .continue}

[% fixme file="placed.js" keep="row" %]

Once again,
we write and run some tests to check that everything is doing what it's supposed to:

[% fixme file="test/test-placed.js" omit="large" %]
[% fixme file="test-placed.out" %]

## How can we render elements? {: #layout-render}
...
[% fixme file="render.js" keep="makeScreen" %]
...
[% fixme file="render.js" keep="draw" %]
...
[% fixme file="test/test-rendered.js" keep="large" %]
...
## How can we wrap elements to fit? {: #layout-fit}
...
[% fixme file="wrapped.js" keep="blockcol" %]
...
## What subset of CSS will we support? {: #layout-css}
...
[% fixme file="micro-dom.js" omit="erase" %]
...
[% fixme file="parse.js" omit="skip" %]

while the two functions that do most of the work are:
{: .continue}

[% fixme file="parse.js" keep="makenode" %]

and:
{: .continue}

[% fixme file="parse.js" keep="makeopening" %]
...
[% fixme file="micro-css.js" keep="css" %]
...
[% fixme file="micro-css.js" keep="id" %]
...
[% fixme file="micro-css.js" keep="ruleset" %]
...
[% fixme file="test/test-styled.js" keep="test" %]
...
the author began wondering whether it really had to be so complicated.
