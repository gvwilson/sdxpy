...
## What will our system look like? {: #templating-syntax}
...
## How do we handle nodes? {: #templating-nodes}
...
## How do we implement node handlers? {: #templating-handlers}
...
[% fixme file="input-static-text.html" %]
